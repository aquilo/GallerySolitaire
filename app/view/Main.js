 ...
 //         global_cardface = Ext.getCmp('cardfaces').down('radiofield[name=cardface]').getGroupValue();
  //        global_evaluations = Ext.getCmp('evaluations').down('radiofield[name=evaluation]').getGroupValue();
      ...
      items: [{
        ...
        '<tr>' +
        '<td align="center" width=31><a href="#" onclick="window.open(encodeURI(\'http://gallery.mapresso.com#phonegap=external\'), \'_system\', \'location=yes\')">' +
        '<img src="resources/data/img/29.png" width="29" "height="29" align="middle"></a></td>' +
        '<td><a href="#" onclick="window.open(encodeURI(\'http://gallery.mapresso.com#phonegap=external\'), \'_system\', \'location=yes\')">' +
        'http://gallery.mapresso.com</a></td>' + 

        '<td align="center" width=31><a href="#" onclick="window.open(encodeURI(\'http://twitter.com/gallerysol1#phonegap=external\'), \'_system\', \'location=yes\')">' +
        '<img src="resources/data/img/Twitter_Social_Icon_Circle_Color.png" width="29" "height="29" align="middle"></a></td>' + 
        
        '<td align="center" width=31><a href="#" onclick="window.open(encodeURI(\'https://www.facebook.com/Gallery-Solitaire-113763543718658#phonegap=external\'), \'_system\', \'location=yes\')">' +
...
/*
        ...
        '<td><a href="#" onclick="window.open(encodeURI(\'https://www.facebook.com/Gallery-Solitaire-113763543718658#phonegap=external\'), \'_system\', \'location=yes\')">' +
        ...
        '<td><a href="#" onclick="window.open(encodeURI(\'http://twitter.com/gallerysol1#phonegap=external\'), \'_system\', \'location=yes\')">' +
