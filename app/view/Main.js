 ...
 //         global_cardface = Ext.getCmp('cardfaces').down('radiofield[name=cardface]').getGroupValue();
  //        global_evaluations = Ext.getCmp('evaluations').down('radiofield[name=evaluation]').getGroupValue();
      ...
      items: [{
        ...
        //            styleHtmlCls: 'rules',
        styleHtmlContent: true,
        html: '<img src="resources/data/img/mittelholzer_strip.png" width="100%"><br><br><div class="rules"><center><h1>Gallery Solitaire</h1>Version 2.6, &copy; 2020, Adrian Herzog<br/><br/>' +
        '<table border=0>' + 
        ...
        '<tr>' +
        '<td align="center" width=31><a href="#" onclick="window.open(encodeURI(\'https://www.facebook.com/Gallery-Solitaire-113763543718658#phonegap=external\'), \'_system\')">' +
        '<img src="resources/data/img/FB_logo_blue_29.png" width="29" "height="29" align="middle"></a></td>' +
        '<td><a href="#" onclick="window.open(encodeURI(\'https://www.facebook.com/Gallery-Solitaire-113763543718658#phonegap=external\'), \'_system\')">' +
